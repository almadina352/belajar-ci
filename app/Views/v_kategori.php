    ...
    <tbody>
        <?php foreach ($product_category as $index => $kategori) : ?>
            <tr>
                ...
                <td><?php echo esc($kategori['name']) ?></td>
                <td><?php echo esc($kategori['description']) ?></td>
                <td>
                        ...
                        <form action="<?= base_url('kategori/edit/' . $kategori['id']) ?>" method="post">
                            ...
                            <div class="modal-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" value="<?= esc($kategori['name']) ?>" placeholder="Nama Kategori" required>
                                </div>
                                <div class="form-group">
                                    <label for="description">Deskripsi</label>
                                    <textarea name="description" class="form-control" id="description" placeholder="Deskripsi Kategori" required><?= esc($kategori['description']) ?></textarea>
                                </div>
                            </div>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('kategori') ?>" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="description">Deskripsi</label>
                        <textarea name="description" class="form-control" id="description" placeholder="Deskripsi Kategori" required></textarea>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
